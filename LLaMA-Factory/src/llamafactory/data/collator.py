...
@dataclass
class RMMMultiModalDataCollatorForSeq2Seq(DataCollatorForSeq2Seq):
    r"""Data collator that supports VLMs.
    ...
    def __call__(self, features: list[dict[str, Any]]) -> dict[str, "torch.Tensor"]:
        ...
        for feature in features:
            ...
            batch_audlens.append(len(audios))
            batch_input_ids.append(feature["input_ids"])
            batch_is_thumbnail.extend(feature.pop("is_thumbnail"))
...
@dataclass
class RMMSFTDataCollatorWith4DAttentionMask(RMMMultiModalDataCollatorForSeq2Seq):
    r"""Data collator for 4d attention mask."""
