...
```text
/home/vieo/vieo/fxy_workspace/fxy/results_ssh/yw_v1.2.0_zh/
...
```text
/home/vieo/vieo/fxy_workspace/fxy/datasets/yw/classes.txt
```
...
```text
/home/vieo/vieo/fxy_workspace/Asking_like_Socrates-main/re_scripts/
```
...
export ZH_OUTPUT_ROOT="/home/vieo/vieo/fxy_workspace/fxy/results_ssh/yw_v1.2.0_zh"
```
