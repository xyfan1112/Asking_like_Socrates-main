...
先确定实际仓库目录。你最新日志使用的是
`/home/vieo/vieo/fxy_workspace/Asking_like_Socrates-main`；如果没有 `-main`，下面会自动选择旧路径。

```bash
if [[ -d /home/vieo/vieo/fxy_workspace/Asking_like_Socrates-main/re_scripts ]]; then
  REPO=/home/vieo/vieo/fxy_workspace/Asking_like_Socrates-main
else
...
## 11. 训练匹配的 B1 与 B2
bash /home/vieo/vieo/fxy_workspace/Asking_like_Socrates-main/re_scripts/main_layer/train_matched_b1_b2.sh
