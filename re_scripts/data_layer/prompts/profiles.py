"""Prompt overlays for the stable custom-classes Socratic pipeline v1.2.2.
...
def _en_profile() -> Dict[str, str]:
    return {
        "reasoner": f"""
[Custom OBB evidence-reasoning extension v1.2.2]
...
""".strip(),
        "perceiver": f"""
[Custom OBB perception extension v1.2.2]
...
""".strip(),
        "verifier": f"""
[Custom OBB verifier extension v1.2.2]
