...
```text
YAML dataset_dir:
/home/vieo/vieo/fxy_workspace/fxy/datasets/dota128-llamafactory
...
```text
/home/vieo/vieo/fxy_workspace/fxy/datasets/dota128-llamafactory/dataset_info.json
```
...
```text
/home/vieo/vieo/fxy_workspace/fxy/results/dota128_pipeline/agent_inputs/train_direct.json
/home/vieo/vieo/fxy_workspace/fxy/results/dota128_pipeline/agent_inputs/val_direct.json
```
...
```text
/home/vieo/vieo/fxy_workspace/fxy/datasets/dota128-llamafactory/dataset_info.json
/home/vieo/vieo/fxy_workspace/fxy/datasets/dota128-llamafactory/dota128_direct_train_official.json
/home/vieo/vieo/fxy_workspace/fxy/datasets/dota128-llamafactory/dota128_direct_val_official.json
```
...
grep -E 'dataset_dir|^dataset:|eval_dataset' \
  /home/vieo/vieo/fxy_workspace/fxy/results/dota128_training/configs/b1_direct_lora.yaml
```

必须是：

```text
dataset_dir: /home/vieo/vieo/fxy_workspace/fxy/datasets/dota128-llamafactory
...
```text
/home/vieo/vieo/fxy_workspace/fxy/results/dota128_training/b1_direct_lora
```
