...
## 1.保证settings
"dota128_root": "/home/vieo/vieo/fxy_workspace/fxy/datasets/dota128",


## 2.无泄漏的数据集

CFG=/home/vieo/vieo/fxy_workspace/Asking_like_Socrates-main/re_scripts/settings.json 

python main_layer/run.py split-scenes   --settings settings.json   --output-root /home/vieo/vieo/fxy_workspace/fxy/datasets/yw128_scene_disjoint   --settings-output /home/vieo/vieo/fxy_workspace/Asking_like_Socrates-main/re_scripts/settings.scene_disjoint.json
...
```bash
cd /home/vieo/vieo/fxy_workspace/Asking_like_Socrates-main/re_scripts_ssh1.2.2
